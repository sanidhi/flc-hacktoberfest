...
export default function Navbar() {
  ...
  <ul className={`bg-white bg-opacity-30 md:bg-white md:bg-opacity-0 md:flex md:items-center md:pb-0 pb-13 absolute md:static  md:z-auto left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
    {
      navLinks.map((link)=>(
